...
class BasicOptions : public Options {
   public:
	...
	addr_t sobelFilter_start_addr1 = 0x73001000;
...
int sc_main(int argc, char **argv) {
	...
	CombinedMemoryInterface iss_mem_if0("MemoryInterface", core0);
	CombinedMemoryInterface iss_mem_if1("MemoryInterface", core1);
